...
def part1(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 4 part 1
    raise NotImplementedError("Solution for Day 4 Part 1 has not been implemented yet.")
...
def part2(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 4 part 2
    raise NotImplementedError("Solution for Day 4 Part 2 has not been implemented yet.")
