...
def part1(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 14 part 1
    raise NotImplementedError("Solution for Day 14 Part 1 has not been implemented yet.")
...
def main():
    ...
    if part is None or part == "1":
        try:
            ...
            print(f"Day 14 Part 1 Solution: {result}")
        except NotImplementedError as e:
            print(f"Day 14 Part 1: {e}")
            exit_code = 1
    
    if part is None or part == "2":
        try:
            result = part2(input_text)
            print(f"Day 14 Part 2 Solution: {result}")
        except NotImplementedError as e:
            print(f"Day 14 Part 2: {e}")
            exit_code = 1
