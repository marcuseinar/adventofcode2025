...
def part1(input_text: str) -> int:
    ...
    raise NotImplementedError("Solution for Day 1 Part 1 has not been implemented yet.")
...
def part2(input_text: str) -> int:
    ...
    raise NotImplementedError("Solution for Day 1 Part 2 has not been implemented yet.")
