...
def part1(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 9 part 1
    raise NotImplementedError("Solution for Day 9 Part 1 has not been implemented yet.")
...
def part2(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 9 part 2
    raise NotImplementedError("Solution for Day 9 Part 2 has not been implemented yet.")
...
def main():
    ...
    if part is None or part == "1":
        try:
            ...
            print(f"Day 9 Part 1 Solution: {result}")
        except NotImplementedError as e:
            print(f"Day 9 Part 1: {e}")
            exit_code = 1
