...
def part1(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 2 part 1
    raise NotImplementedError("Solution for Day 2 Part 1 has not been implemented yet.")
...
def part2(input_text: str) -> int:
    ...
    """
    # TODO: Implement solution for day 2 part 2
    raise NotImplementedError("Solution for Day 2 Part 2 has not been implemented yet.")
